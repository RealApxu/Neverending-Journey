...
Global("Beorn_Talk","GLOBAL",0)~ THEN BEGIN 0
...
IF ~~ THEN BEGIN 5
  ...
  IF ~~ THEN REPLY ~Sounds good to me!  Muhahahaha!~ DO ~SetGlobal("Sad_Gnomes","GLOBAL",1)
Enemy()
...
IF WEIGHT #2 ~Global("Beorn_Talk","GLOBAL",1)
GlobalLT("Beorn_Quest","GLOBAL",3)~ THEN BEGIN 9
...
IF ~~ THEN BEGIN 12
  ...
  IF ~~ THEN REPLY ~I'll see what I can do.  Farewell.~ DO ~SetGlobal("Beorn_Talk","GLOBAL",2)
SetGlobal("Beorn_Quest","GLOBAL",2)~ EXIT
...
IF ~~ THEN BEGIN 14
  ...
  IF ~~ THEN DO ~SetGlobal("Beorn_Talk","GLOBAL",2)
SetGlobal("Beorn_Quest","GLOBAL",1)~ EXIT
END

IF WEIGHT #3 ~Global("Beorn_Quest","GLOBAL",1)
GlobalGT("Beorn_Talk","GLOBAL",1)~ THEN BEGIN 15
...
IF WEIGHT #4 ~Global("Beorn_Quest","GLOBAL",2)
GlobalGT("Beorn_Talk","GLOBAL",1)~ THEN BEGIN 16
...
IF WEIGHT #0 ~GlobalGT("Beorn_Quest","GLOBAL",2)
GlobalLT("Beorn_Quest","GLOBAL",5)
!Global("Gnome_Hate","GLOBAL",1)~ THEN BEGIN 18
...
IF ~GlobalGT("Beorn_Quest","GLOBAL",5)
Global("VP_BeornThanks","LOCALS",0)~ THEN BEGIN 19
  ...
  IF ~~ THEN REPLY ~Could you provide me with some healing?~ DO ~SetGlobal("VP_BeornThanks","LOCALS",1)
StartStore("LDD_Beor",Protagonist)~ EXIT
...
IF ~~ THEN BEGIN 20
  ...
  IF ~GlobalLT("SPRITE_IS_DEADUMBH8009","GLOBAL",15)~ THEN REPLY ~I'll see what I can do. Farewell.~ DO ~SetGlobal("Beorn_Talk","GLOBAL",2)
SetGlobal("Beorn_Quest","GLOBAL",2)~ EXIT
  IF ~GlobalGT("SPRITE_IS_DEADUMBH8009","GLOBAL",14)~ THEN REPLY ~But I have already eliminated them all.~ DO ~SetGlobal("Beorn_Talk","GLOBAL",2)
SetGlobal("Beorn_Quest","GLOBAL",2)~ GOTO 23
  IF ~~ THEN REPLY ~I changed my mind. I can't do it.~ GOTO 14
END
...
IF ~GlobalGT("Beorn_Quest","GLOBAL",5)
Global("VP_BeornThanks","LOCALS",1)~ THEN BEGIN 22
