...
IF WEIGHT #2 ~NumTimesTalkedToGT(0)~ THEN BEGIN 1
  ...
  IF ~Global("Chief_Dead","GLOBAL",1)Global("Saablic_Quest","GLOBAL",1)
!PartyHasItem("Krilag")~ THEN REPLY ~I have disposed of the orog chieftain.~ GOTO 13
...
IF ~~ THEN BEGIN 10
  ...
  IF ~~ THEN REPLY ~Goodbye, Saablic.~ DO ~SetGlobal("Saablic_Known","GLOBAL",2)
...
EscapeArea()~ SOLVED_JOURNAL ~Upper Dorn’s Deep.
