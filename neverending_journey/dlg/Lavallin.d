...
IF WEIGHT #0 ~NumTimesTalkedTo(0) Global("VP_Lavallins_Plot","GLOBAL",0)~ THEN BEGIN 0
...
IF ~~ THEN BEGIN 10
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Lavallins_Plot","GLOBAL",1) RealSetGlobalTimer("VP_Lavallin_Leaves","GLOBAL",30)~ EXIT // First rejection to Lavallin's quest
END
...
IF ~~ THEN BEGIN 11
  ...
  IF ~InParty("Hrothgar")~ THEN DO ~SetGlobal("VP_Lavallins_Plot","GLOBAL",2) SetGlobal("VP_Hrothgar_Lavallin","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT03")~ EXIT
...
IF ~~ THEN BEGIN 15
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Lavallins_Plot","GLOBAL",5) RealSetGlobalTimer("VP_Activate_Portal","GLOBAL",10) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT37")~ EXIT
END
...
IF ~~ THEN BEGIN 17
  ...
  IF ~~ THEN DO ~SetGlobal("VP_Lavallins_Plot","GLOBAL",6) RealSetGlobalTimer("VP_Lavallin_Leaves","GLOBAL",30) EraseJournalEntry(%Lavallin's Thief.
...
I declined to help a mage named Lavallin search for his petty thief. I really do not have the time to let myself be side tracked... the quicker I can find the information that I came here for, the quicker I can do the necessary and get back to my search for Imoen and Irenicus.%) GiveItemCreate("POTN33",Player1,1,0,0) GiveItemCreate("POTN34",Player1,1,0,0) GivePartyGold(500)~ EXIT
END // Second rejection to Lavallin's quest

IF WEIGHT #-3 ~Global("VP_LvQuest_Botched","GLOBAL",0) Global("VP_Lavallins_Plot","GLOBAL",9) Dead("Bartlemy") GlobalLT("VP_Meeting_Delrysia","GLOBAL",2)~ THEN BEGIN 18
...
IF ~~ THEN BEGIN 26
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LvQuest_Botched","GLOBAL",1) EraseJournalEntry(%Lavallin's Thief.
...
The search of Lavallin's room revealed yet another interested party in this ring of might... one Delrysia. Damn these mages... how is it I always end up embroiled in the petty squabbles of others! I will have the truth out of that mage... one way or another! Bartlemy was adamant that it was this Delrysia's insistence to add a necromantic component to the ring which caused the explosion, and that she herself is now hiding in the sewers... *the only place fit for her now* were his words. Now I wonder what he meant by that? The mage has now offered me further inducement to enter the sewers, confront Delrysia and force her to return his ring. Is there any truth in the words of this mage I asked myself? Or was I once again being used as a pawn in the power struggles of others? Whatever the truth I decided to have no further part in this quest and when asked to return all that his goblin had stolen, Bartlemy merely laughed and attacked me, along with his goblin friend.%) AddexperienceParty(5000) GiveItemCreate("SCRL8O",Player1,1,0,0) GiveItemCreate("SCRL8P",Player1,1,0,0) GiveItemCreate("SCRL8Q",Player1,1,0,0) GiveItemCreate("SCRL8R",Player1,1,0,0) GiveGoldForce(2000) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT37")~ EXIT
END
...
The search of Lavallin's room revealed yet another interested party in this ring of might... one Delrysia. Damn these mages... how is it I always end up embroiled in the petty squabbles of others! I will have the truth out of that mage... one way or another! Bartlemy was adamant that it was this Delrysia's insistence to add a necromantic component to the ring which caused the explosion, and that she herself is now hiding in the sewers... *the only place fit for her now* were his words. Now I wonder what he meant by that? The mage has now offered me further inducement to enter the sewers, confront Delrysia and force her to return his ring. Is there any truth in the words of this mage I asked myself? Or was I once again being used as a pawn in the power struggles of others? Whatever the truth I decided to have no further part in this quest and when asked to return all that his goblin had stolen, Bartlemy merely laughed and attacked me, along with his goblin friend.%) AddexperienceParty(5000) GiveItemCreate("POTN33",Player1,1,0,0) GiveItemCreate("POTN34",Player1,1,0,0) GiveItemCreate("SCRL8O",Player1,1,0,0) GivePartyGold(500) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT37")~ EXIT
END

IF WEIGHT #-18 ~GlobalGT("VP_Lavallins_Plot","GLOBAL",10) GlobalGT("VP_Meeting_Delrysia","GLOBAL",1) Global("VP_LvQuest_Done","GLOBAL",0) Global("VP_LvQuest_Botched","GLOBAL",0) GlobalLT("VP_Delrisia_Letter","GLOBAL",3) Global("VP_Restore_Ring","GLOBAL",0)~ THEN BEGIN 29
  SAY ~You startled me, <CHARNAME>! I do not see our little thief with you, did you not discover him?~ [laval15]
...
The search of Lavallin's room revealed yet another interested party in this ring of might... one Delrysia. Damn these mages... how is it I always end up embroiled in the petty squabbles of others! I will have the truth out of that mage... one way or another! Bartlemy was adamant that it was this Delrysia's insistence to add a necromantic component to the ring which caused the explosion, and that she herself is now hiding in the sewers... *the only place fit for her now* were his words. Now I wonder what he meant by that? The mage has now offered me further inducement to enter the sewers, confront Delrysia and force her to return his ring. Is there any truth in the words of this mage I asked myself? Or was I once again being used as a pawn in the power struggles of others? Whatever the truth I decided to have no further part in this quest and when asked to return all that his goblin had stolen, Bartlemy merely laughed and attacked me, along with his goblin friend.%) AddexperienceParty(19500) GiveItemCreate("POTN33",Player1,1,0,0) GiveItemCreate("POTN34",Player1,1,0,0) GiveItemCreate("SCRL8O",Player1,1,0,0) GivePartyGold(500) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT37")~ EXIT
END

/*IF WEIGHT #-5 ~Global("VP_My_Plot_Ends","LOCALS",0) Global("VP_Lavallins_Plot","GLOBAL",10) Global("VP_Meeting_Delrysia","GLOBAL",2) Dead("Bartlemy")~ THEN BEGIN 37
  SAY ~You startled me, <CHARNAME>! I do not see our little thief with you, did you not discover him?~ [laval15]
...
IF ~~ THEN BEGIN 38
  ...
  IF ~~ THEN DO ~SetGlobal("VP_LvQuest_Done","GLOBAL",1) EraseJournalEntry(%Lavallin's Thief.
...
IF WEIGHT #-19 ~Global("VP_My_Quest_IsOver","LOCALS",0) GlobalGT("VP_Lavallins_Plot","GLOBAL",10) GlobalGT("VP_Meeting_Delrysia","GLOBAL",1) Global("VP_Restore_Ring","GLOBAL",0) OR(3) Global("VP_LvQuest_Done","GLOBAL",1) Global("VP_LvQuest_Botched","GLOBAL",1) Global("VP_Delrisia_Letter","GLOBAL",3)~ THEN BEGIN 40
...
IF WEIGHT #1 ~Global("VP_Return_Ring","LOCALS",0) GlobalGT("VP_Lavallins_Plot","GLOBAL",10) GlobalGT("VP_Meeting_Delrysia","GLOBAL",1) GlobalGT("VP_Restore_Ring","GLOBAL",0)~ THEN BEGIN 41
...
IF ~~ THEN BEGIN 54
  ...
  IF ~~ THEN DO ~TakePartyItem("DeRing") GiveItemCreate("BOOKINF",LastTalkedToBy,0,0,0) AddXPObject(Player1,45500) AddXPObject(Player2,45500) AddXPObject(Player3,45500) AddXPObject(Player4,45500) AddXPObject(Player5,45500) AddXPObject(Player6,45500)~ EXIT
END
...
IF ~Global("VP_Lavallins_Plot","GLOBAL",9) OR(2) Global("VP_LvQuest_Botched","GLOBAL",1) Global("VP_LvQuest_Done","GLOBAL",1)~ THEN BEGIN 56
...
IF WEIGHT #-9 ~Global("VP_Lavallins_Plot","GLOBAL",9) Global("VP_LvQuest_Botched","GLOBAL",0) GlobalLT("VP_Delrisia_Letter","GLOBAL",3) !Dead("Bartlemy") !PartyHasItem("DELETTER")~ THEN BEGIN 58
...
The search of Lavallin's room revealed yet another interested party in this ring of might... one Delrysia. Damn these mages... how is it I always end up embroiled in the petty squabbles of others! I will have the truth out of that mage... one way or another! Bartlemy was adamant that it was this Delrysia's insistence to add a necromantic component to the ring which caused the explosion, and that she herself is now hiding in the sewers... *the only place fit for her now* were his words. Now I wonder what he meant by that? The mage has now offered me further inducement to enter the sewers, confront Delrysia and force her to return his ring. Is there any truth in the words of this mage I asked myself? Or was I once again being used as a pawn in the power struggles of others? Whatever the truth I decided to have no further part in this quest and when asked to return all that his goblin had stolen, Bartlemy merely laughed and attacked me, along with his goblin friend.%) AddexperienceParty(19500) GiveItemCreate("POTN33",Player1,1,0,0) GiveItemCreate("POTN34",Player1,1,0,0) GiveItemCreate("SCRL8O",Player1,1,0,0) GivePartyGold(5000) ClearAllActions() StartCutSceneMode() StartCutScene("VPCutT37")~ EXIT
END
...
IF WEIGHT #-9 ~Global("VP_Find_Delrysia","LOCALS",0) Global("VP_Lavallins_Plot","GLOBAL",9) GlobalLT("VP_Meeting_Delrysia","GLOBAL",2) Global("VP_Delrisia_Letter","GLOBAL",3) Dead("Bartlemy")~ THEN BEGIN 73
...
IF WEIGHT #-10 ~Global("VP_Find_Delrysia","LOCALS",0) Global("VP_Lavallins_Plot","GLOBAL",10) GlobalLT("VP_Meeting_Delrysia","GLOBAL",2) Global("VP_Delrisia_Letter","GLOBAL",3) !Dead("Bartlemy")~ THEN BEGIN 76
//Double check because this condition !Dead("Bartlemy") is true
...
IF WEIGHT #-11 ~Global("VP_Lavallins_Plot","GLOBAL",9) Global("VP_LvQuest_Done","GLOBAL",0) Global("VP_LvQuest_Botched","GLOBAL",0) GlobalLT("VP_Delrisia_Letter","GLOBAL",3) GlobalLT("VP_Meeting_Delrysia","GLOBAL",2) !Dead("Bartlemy") PartyHasItem("DELETTER")~ THEN BEGIN 79
...
IF WEIGHT #-12 ~Global("VP_Lavallins_Plot","GLOBAL",9) Global("VP_LvQuest_Done","GLOBAL",0) Global("VP_LvQuest_Botched","GLOBAL",0) Global("VP_Meeting_Delrysia","GLOBAL",2) GlobalLT("VP_Delrisia_Letter","GLOBAL",3) Dead("Bartlemy") Dead("Delrysia")~ THEN BEGIN 81
  SAY ~You startled me, <CHARNAME>! I do not see our little thief with you, did you not discover him?~ [laval15]
...
IF WEIGHT #-13 ~Global("VP_Lavallins_Plot","GLOBAL",9) Global("VP_My_Plot_Ends","LOCALS",0) Global("VP_Meeting_Delrysia","GLOBAL",2) Dead("Bartlemy") Dead("Delrysia") OR(3) Global("VP_Delrisia_Letter","GLOBAL",3) Global("VP_LvQuest_Done","GLOBAL",1) Global("VP_LvQuest_Botched","GLOBAL",1)~ THEN BEGIN 93
...
IF WEIGHT #-14 ~Global("VP_Lavallins_Plot","GLOBAL",9) Global("VP_LvQuest_Done","GLOBAL",0) Global("VP_LvQuest_Botched","GLOBAL",0) Global("VP_Meeting_Delrysia","GLOBAL",3) GlobalLT("VP_Delrisia_Letter","GLOBAL",3) Dead("Bartlemy") !Dead("Delrysia")~ THEN BEGIN 100
...
IF WEIGHT #-15 ~Global("VP_Lavallins_Plot","GLOBAL",9) Global("VP_Meeting_Delrysia","GLOBAL",3) Global("VP_My_Plot_Ends","LOCALS",0) Dead("Bartlemy") !Dead("Delrysia") OR(3) Global("VP_Delrisia_Letter","GLOBAL",3) Global("VP_LvQuest_Done","GLOBAL",1) Global("VP_LvQuest_Botched","GLOBAL",1)~ THEN BEGIN 117
//!Dead("Delrysia") is a double check for "VP_Meeting_Delrysia" = 3
  SAY ~Hello again <CHARNAME>. Does your reappearance here mean our little problem is sorted?~
...
IF WEIGHT #-16 ~Global("VP_Lavallins_Plot","GLOBAL",10) Global("VP_LvQuest_Done","GLOBAL",0) Global("VP_LvQuest_Botched","GLOBAL",0) GlobalLT("VP_Delrisia_Letter","GLOBAL",3) Global("VP_Meeting_Delrysia","GLOBAL",2) !Dead("Bartlemy") Dead("Delrysia")~ THEN BEGIN 129
...
IF WEIGHT #-17 ~Global("VP_Lavallins_Plot","GLOBAL",10) Global("VP_Meeting_Delrysia","GLOBAL",2) Global("VP_My_Plot_Ends","LOCALS",0) !Dead("Bartlemy") Dead("Delrysia") OR(3) Global("VP_LvQuest_Done","GLOBAL",1) Global("VP_LvQuest_Botched","GLOBAL",1) Global("VP_Delrisia_Letter","GLOBAL",3)~ THEN BEGIN 135
//Dead("Delrysia") is a double check for "VP_Meeting_Delrysia" = 2
  SAY ~Ah... you return <CHARNAME>, have you good news for me?~
