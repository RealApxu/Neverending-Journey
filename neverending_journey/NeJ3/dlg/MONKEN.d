...
IF ~NumberOfTimesTalkedTo(0)~ THEN BEGIN 0 // from:
  ...
  IF ~  PartyGoldGT(0)~ THEN REPLY ~It would seem that I have no choice; here's all my money.~ DO ~TakePartyGold(1000000) SetGlobal("BribeEnforcer","GLOBAL",1) Shout(2) EscapeArea()~ EXIT
  IF ~~ THEN REPLY ~Up yours, you uppity bald virgin.~ DO ~Shout(1) Enemy()~ EXIT
