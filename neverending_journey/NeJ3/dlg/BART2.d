...
IF ~RandomNum(4,1)~ THEN BEGIN 0
  ...
  IF ~~ THEN REPLY ~Yes.~ DO ~StartStore("tav4809",LastTalkedToBy(Myself))~ JOURNAL ~Nashkel festival.
...
IF ~RandomNum(4,2)~ THEN BEGIN 1
  ...
  IF ~~ THEN DO ~StartStore("tav4809",LastTalkedToBy(Myself))~ JOURNAL ~The iron shortage.
...
IF ~RandomNum(4,3)~ THEN BEGIN 2
  ...
  IF ~~ THEN DO ~StartStore("tav4809",LastTalkedToBy(Myself))~ JOURNAL ~Oddities west of Nashkel.
...
IF ~RandomNum(4,4)~ THEN BEGIN 3
  ...
  IF ~~ THEN DO ~StartStore("tav4809",LastTalkedToBy(Myself))~ EXIT
END