...
IF ~~ THEN BEGIN 2
  ...
  IF ~~ THEN REPLY ~We�ll see about that.~ DO ~SetGlobal("VP_MyGroup_Attacked","MYAREA",1) Enemy()~ EXIT
  IF ~~ THEN REPLY ~What, just you?  Hahaha!~ DO ~SetGlobal("VP_MyGroup_Attacked","MYAREA",1) Enemy()~ EXIT
END
