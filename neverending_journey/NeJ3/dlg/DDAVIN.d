...
IF ~NumTimesTalkedTo(0) Global("7004_Slave_Run","GLOBAL",0)~ THEN BEGIN 0
...
IF ~~ THEN BEGIN 7
  ...
  IF ~OR(2) Global("Frostbite_Dead","GLOBAL",1) Global("SPRITE_IS_DEADFROSTBITE","GLOBAL",1)~ THEN REPLY ~The creature you speak of is dead.  There will be no more sacrifices.~ DO ~AddexperienceParty(10000) SetGlobal("Kill_Frost","GLOBAL",4) SetGlobal("Frostbite_Dead","GLOBAL",1)~ JOURNAL ~Wyrm's Tooth.
...
IF ~~ THEN BEGIN 12
  ...
  IF ~OR(2) Global("Kontik_Dead","GLOBAL",0) Global("SPRITE_IS_DEADKONTIK","GLOBAL",0)~ THEN REPLY ~Very well.  I shall do so.  Farewell.~ DO ~SetGlobal("Explore_Cave","GLOBAL",3)~ UNSOLVED_JOURNAL ~Wyrm's Tooth.
...
We agreed to help Davin and the other slaves gain their freedom. However, this could be a difficult task considering the number of giants we would have to fight here in the caverns. Davin said this might not be necessary since there is a cave to the north of the slave pens that may lead to freedom. We have agreed to scout out the cave for any dangers and see if it indeed leads to an exit.~ EXIT
  IF ~OR(2) Global("Kontik_Dead","GLOBAL",1) Global("SPRITE_IS_DEADKONTIK","GLOBAL",1)~ THEN REPLY ~I have done so already.  You need fear nothing in the cave.~ UNSOLVED_JOURNAL ~Wyrm's Tooth.
...
IF ~~ THEN BEGIN 13
  ...
  IF ~OR(2) Global("Gorg_Dead","GLOBAL",0) Global("SPRITE_IS_DEADGORG","GLOBAL",0)~ THEN REPLY ~Very well.  I shall do so.  Farewell.~ DO ~SetGlobal("Kill_Gorg","GLOBAL",3)~ UNSOLVED_JOURNAL ~Wyrm's Tooth.
...
We need to slay the frost giant that guards the slave pens, and we need to accomplish this without alerting the other giants. This may prove a difficult task, but it is necessary.~ EXIT
  IF ~OR(2) Global("Gorg_Dead","GLOBAL",1) Global("SPRITE_IS_DEADGORG","GLOBAL",1)~ THEN REPLY ~I have done so already.  It seems there are no obstacles to your freedom.  Leave now, while you can.~ DO ~SetGlobal("Free_Davin","GLOBAL",4) SetGlobal("Gorg_Dead","GLOBAL",1) EraseJournalEntry(%Wyrm's Tooth.

We met a slave named Davin. He asked me to free him and the other slaves from the frost giants. We have agreed to do so.%) EraseJournalEntry(%Wyrm's Tooth.

We have discovered that the frost giants are sacrificing slaves to some creature that lives here in the caverns.%) EraseJournalEntry(%Wyrm's Tooth.

We have found a group of people in the caverns that are held by the frost giants as slaves.%) EraseJournalEntry(%Wyrm's Tooth.

We informed Davin Berenson that we have slain the creature known as Frostbite. With the beast dead, the slaves need not fear being sacrificed any longer.%) EraseJournalEntry(%Wyrm's Tooth.

We met a slave named Davin. He asked me to free him and the other slaves from the frost giants. We have agreed to do so.%) EraseJournalEntry(%Wyrm's Tooth.

The slave, Davin Berenson, told us of some creature that the frost giants are sacrificing slaves to. This is a terrible fate that no one should have to suffer.%) EraseJournalEntry(%Wyrm's Tooth.

We met a slave named Davin Berenson. He asked us to free him and the other slaves from the frost giants. We refused to help him at this time. None of us want to fight a cavern full of frost giants. Such a battle could be very costly.%) EraseJournalEntry(%Wyrm's Tooth.

We met a slave named Davin Berenson. He asked us to free him and the other slaves from the frost giants. We told him we would take the matter under consideration. Fighting a cavern full of frost giants could be a very costly battle.%) EraseJournalEntry(%Wyrm's Tooth.

We agreed to help Davin and the other slaves gain their freedom. However, this could be a difficult task considering the number of giants we would have to fight here in the caverns. Davin said this might not be necessary since there is a cave to the north of the slave pens that may lead to freedom. We have agreed to scout out the cave for any dangers and see if it indeed leads to an exit.%) EraseJournalEntry(%Wyrm's Tooth.

We agreed to help Davin and the other slaves gain their freedom. However, this could be a difficult task considering the number of giants we would have to fight here in the caverns. Davin said this might not be necessary since there is a cave to the north of the slave pens that may lead to freedom. Davin asked us to scout out this cave for dangers and to see if it indeed leads to freedom. Fortunately, we have already done this.%) EraseJournalEntry(%Wyrm's Tooth.

We need to slay the frost giant that guards the slave pens, and we need to accomplish this without alerting the other giants. This may prove a difficult task, but it is necessary.%) EraseJournalEntry(%Wyrm's Tooth.

We told Davin that we cleared the cave north of the slave pens of any danger. We now need to slay the guard and then the slaves will be free.%) EraseJournalEntry(%Wyrm's Tooth.

We told Davin that the slave pen guard is dead. We now need to go to the cave to the north of the pens and clear it of any dangers.%) EraseJournalEntry(%Wyrm's Tooth.

We met a slave named Davin Berenson. He told us that the frost giants are sacrificing the slaves to some creature here in the caverns. We have agreed to go and slay this beast, whatever it may be.%) EraseJournalEntry(%Wyrm's Tooth.

We met a slave named Davin Berenson. He told us that the frost giants are sacrificing the slaves to some creature here in the caverns. We agreed that we have no desire to fight some unknown beast.%) EraseJournalEntry(%Wyrm's Tooth.

We met a slave named Davin Berenson. He told us that the frost giants are sacrificing the slaves to some creature here in the caverns. Although we agree that we have no desire to fight some unknown beast, we are still considering the matter.%) EraseJournalEntry(%Wyrm's Tooth.

We informed Davin Berenson that we have slain the creature known as Frostbite. With the beast dead, the slaves need not fear being sacrificed any longer.%) EraseJournalEntry(%Upper Dorn's Deep.
...
IF ~~ THEN BEGIN 14
  ...
  IF ~~ THEN REPLY ~Farewell, Davin.~ DO ~AddexperienceParty(10000) SetGlobal("7004_Slave_Run","GLOBAL",1)~ EXIT
END
...
IF ~~ THEN BEGIN 19
  ...
  IF ~OR(2) Global("Joril_Dead","GLOBAL",1) Global("SPRITE_IS_DEADJORIL","GLOBAL",1)~ THEN REPLY ~I have slain the giant leader, Joril.  You are free to leave by that path.~ DO ~SetGlobal("7004_Slave_Run","GLOBAL",2) SetGlobal("Joril_Dead","GLOBAL",1) EraseJournalEntry(%Wyrm's Tooth.
...
We told Davin of Joril Frostbeard's death. With his death the path to freedom for the slaves has been opened.~ GOTO 24
  IF ~Global("Gorg_Dead","GLOBAL",1) OR(2) Global("Kontik_Dead","GLOBAL",1) Global("SPRITE_IS_DEADKONTIK","GLOBAL",1)~ THEN REPLY ~I have cleared the north cave of any *hazards* and slain the guard.  You are free to go now.~ DO ~SetGlobal("7004_Slave_Run","GLOBAL",1) SetGlobal("Gorg_Dead","GLOBAL",1) EraseJournalEntry(%Wyrm's Tooth.
...
We told Davin that we cleared the cave north of the slave pens of any danger. We also have slain the frost giant guarding the pens. This opened the path to freedom for the slaves.~ GOTO 14
  IF ~OR(2) Global("Kontik_Dead","GLOBAL",1) Global("SPRITE_IS_DEADKONTIK","GLOBAL",1) OR(2) Global("Gorg_Dead","GLOBAL",0) Global("SPRITE_IS_DEADGORG","GLOBAL",0)~ THEN REPLY ~I have cleared the north cave of any *hazards* for you.  I will go and slay the guard now.  Farewell.~ DO ~SetGlobal("Kill_Gorg","GLOBAL",3) SetGlobal("Gorg_Dead","GLOBAL",1)~ UNSOLVED_JOURNAL ~Wyrm's Tooth.
...
We told Davin that we cleared the cave north of the slave pens of any danger. We now need to slay the guard and then the slaves will be free.~ EXIT
  IF ~OR(2) Global("Gorg_Dead","GLOBAL",1) Global("SPRITE_IS_DEADGORG","GLOBAL",1) OR(2) Global("Kontik_Dead","GLOBAL",0) Global("SPRITE_IS_DEADKONTIK","GLOBAL",0)~ THEN REPLY ~I have slain the guard.  I will go and clear the north cave for you now.  Farewell.~ UNSOLVED_JOURNAL ~Wyrm's Tooth.
...
IF ~~ THEN BEGIN 21
  ...
  IF ~OR(2) Global("Frostbite_Dead","GLOBAL",1) Global("SPRITE_IS_DEADFROSTBITE","GLOBAL",1)~ THEN REPLY ~I have already slain the beast.  You need no longer fear it.~ DO ~AddexperienceParty(12500) SetGlobal("Kill_Frost","GLOBAL",4) SetGlobal("Frostbite_Dead","GLOBAL",1)~ GOTO 9
  IF ~~ THEN REPLY ~Farewell for now.~ EXIT
END

IF ~~ THEN BEGIN 22
  SAY ~Yes, and we are all very grateful.  How goes the task?~
  IF ~OR(2) Global("Frostbite_Dead","GLOBAL",1) Global("SPRITE_IS_DEADFROSTBITE","GLOBAL",1)~ THEN REPLY ~I have slain the beast.  You need no longer fear it.~ DO ~AddexperienceParty(12500) SetGlobal("Kill_Frost","GLOBAL",4) SetGlobal("Frostbite_Dead","GLOBAL",1)~ JOURNAL ~Wyrm's Tooth.
...
We informed Davin Berenson that we have slain the creature known as Frostbite. With the beast dead, the slaves need not fear being sacrificed any longer.~ GOTO 9
  IF ~OR(2) Global("Frostbite_Dead","GLOBAL",0) Global("SPRITE_IS_DEADFROSTBITE","GLOBAL",0)~ THEN REPLY ~I have yet to complete the quest but I am working on it.  Farewell for now.~ EXIT
END
